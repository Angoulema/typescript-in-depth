export function sealed(p: string) {
    return function(target: Function): void {
        ...
        Object.seal(target); // target is constructor - static can't be changed
        Object.seal(target.prototype); // methods of instance can't be changed
    };
}
...
// for this task target is prototype
